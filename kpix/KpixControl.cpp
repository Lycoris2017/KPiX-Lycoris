...
void KpixControl::swRunThread() {
   ...
   //if(wmqInKpixCon)
   cout<<"[kpixControl:dev] swRunThread() called here!"<<endl;
...
void KpixControl::command ( string name, string arg ) {
   ...
   long         tme;
   struct tm    *tm_data;
   if(wmqInKpixCon) cout<<"[KpixControl:dev] command(), name == "<< name <<"; arg == "<< arg <<endl;
...
void KpixControl::setRunState ( string state ) {
   ...
   if(wmqInKpixCon) cout<<"[KpixControl:dev] setRunState runs here!"<<endl;
   ...
   // Running state is requested
      ...
      if(wmqInKpixCon) cout<<"[KpixControl:dev] RunCount == "<<swRunCount_<<endl;
...
void KpixControl::hardReset ( ) {
   ...
   System::hardReset();
   //cout<<"[kpixControl:dev] I am actually hardreset from here!"<<endl;
